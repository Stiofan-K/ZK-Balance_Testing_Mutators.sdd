...
upgrades = {
	...
	commweapon_nanoplaguecanister = {
		name = "Nanoplague Canister",
		description = "Revives wrecks in a moderate area into neutral zombies",
	},
	commweapon_nanoplaguedart = {
		name = "Nanoplague Dart",
		description = "Quickly revives wrecks in a small area into neutral Zombies",
	},
