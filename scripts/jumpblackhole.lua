...
function preJump(turn,distance)
	...
	EmitSfx(lforearm, GG.Script.UNIT_SFX4)
	EmitSfx(rforearm, GG.Script.UNIT_SFX4)
	EmitSfx(lshoulder, GG.Script.UNIT_SFX5)
	EmitSfx(rshoulder, GG.Script.UNIT_SFX5)
	EmitSfx(lshin, GG.Script.UNIT_SFX5)
	EmitSfx(rshin, GG.Script.UNIT_SFX5)
...
function jumping(jumpPercent)
	if jumpPercent < 30 or jumpPercent > 70 then
		...
		EmitSfx(rfoot, GG.Script.UNIT_SFX1)
		EmitSfx(lfoot, GG.Script.UNIT_SFX4)
		EmitSfx(rfoot, GG.Script.UNIT_SFX4)
	else
		EmitSfx(lshin, GG.Script.UNIT_SFX5)
