...
local RELOADTIME = wd and WeaponDefs[wd].reload*30 or 10*30
...
function preJump(turn,distance)
	...
	EmitSfx(foot1, GG.Script.UNIT_SFX5)
	EmitSfx(foot2, GG.Script.UNIT_SFX5)
	EmitSfx(leg1, GG.Script.UNIT_SFX4)
	EmitSfx(leg2, GG.Script.UNIT_SFX4)
	EmitSfx(shoulder, GG.Script.UNIT_SFX4)
	EmitSfx(shoulder_left, GG.Script.UNIT_SFX4)
end

function beginJump()
	EmitSfx(foot1, GG.Script.UNIT_SFX5)
	EmitSfx(foot2, GG.Script.UNIT_SFX5)
	EmitSfx(foot1, GG.Script.UNIT_SFX4)
	EmitSfx(foot2, GG.Script.UNIT_SFX4)
	EmitSfx(leg1, GG.Script.UNIT_SFX5)
	EmitSfx(leg2, GG.Script.UNIT_SFX5)
	EmitSfx(shoulder, GG.Script.UNIT_SFX2)
	EmitSfx(shoulder_left, GG.Script.UNIT_SFX2)
end

function jumping(jumpPercent)
	EmitSfx(shoulder, GG.Script.UNIT_SFX5)
	EmitSfx(shoulder_left, GG.Script.UNIT_SFX5)
