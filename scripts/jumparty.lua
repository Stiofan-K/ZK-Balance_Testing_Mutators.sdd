...
local flaps = {lflap1,lflap2,lflap3,lflap4,rflap1,rflap2,rflap3,rflap4}
...
function preJump(turn,distance)
	...
	for i,flap in ipairs(flaps) do 
		EmitSfx(flap, GG.Script.UNIT_SFX7)
	end
	EmitSfx(pelvis, GG.Script.UNIT_SFX7)
	EmitSfx(base, GG.Script.UNIT_SFX7)
	EmitSfx(rupleg, GG.Script.UNIT_SFX5)
	EmitSfx(lupleg, GG.Script.UNIT_SFX5)
end

function beginJump()
	EmitSfx(rupleg, GG.Script.UNIT_SFX7)
	EmitSfx(lupleg, GG.Script.UNIT_SFX7)
	EmitSfx(rupleg, GG.Script.UNIT_SFX8)
	EmitSfx(lupleg, GG.Script.UNIT_SFX8)
end

function jumping(jumpPercent)
	
	if jumpPercent < 30 or jumpPercent > 70 then
		EmitSfx(rloleg, GG.Script.UNIT_SFX7)
		EmitSfx(lloleg, GG.Script.UNIT_SFX7)
	else
		EmitSfx(rloleg, GG.Script.UNIT_SFX9)
		EmitSfx(lloleg, GG.Script.UNIT_SFX9)
	end
	if jumpPercent < 40 then
		EmitSfx(rfoot, GG.Script.UNIT_SFX5)
		EmitSfx(lfoot, GG.Script.UNIT_SFX5)
	end
end
