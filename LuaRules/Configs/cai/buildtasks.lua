		...
		factoryByDefId = {
			...
			[UnitDefNames['factoryamph'].id] = {
				...
				[6] = { -- skirm
					importanceMult = 1.4,
					count = 1,
					[1] = {ID = UnitDefNames['amphtankskirm'].id, chance = 0.95},
					[2] = {ID = UnitDefNames['amphtanksubassault'].id, chance = 0.05},
				},
				...
				[7] = { -- riot
					...
					[2] = {ID = UnitDefNames['amphtankskirm'].id, chance = 0.15},
					[3] = {ID = UnitDefNames['amphtankarty'].id, chance = 0.05},
				},
