...
local moduleDefs = {
	...
	{
		name = "commweapon_nanoplaguecanister",
		humanName = "Nanoplague Canister",
		description = "Nanoplague Canister - Resurrects wrecks in an area into zombies.",
		image = moduleImagePath .. "module_resurrect.png",
		limit = 1,
		cost = 400 * COST_MULT,
		requireChassis = disableResurrect and {} or {"assault", "recon", "strike", "knight"},
		requireLevel = 3,
		slotType = "adv_weapon",
		applicationFunction = function (modules, sharedData)
			if sharedData.noMoreWeapons then
			...
			if not sharedData.weapon1 then
				sharedData.weapon1 = "commweapon_nanoplaguecanister"
			else
				sharedData.weapon2 = "commweapon_nanoplaguecanister"
			end
		end
	},
	{
		name = "commweapon_nanoplaguedart",
		humanName = "Nanoplague Dart",
		description = "Nanoplague Dart - Quickly resurrects wrecks in a small area into zombies.",
		image = moduleImagePath .. "module_resurrect.png",
		limit = 1,
		cost = 400 * COST_MULT,
		requireChassis = disableResurrect and {} or {"support", "recon", "knight"},
		requireLevel = 3,
		slotType = "adv_weapon",
		applicationFunction = function (modules, sharedData)
			if sharedData.noMoreWeapons then
			...
			if not sharedData.weapon1 then
				sharedData.weapon1 = "commweapon_nanoplaguedart"
			else
				sharedData.weapon2 = "commweapon_nanoplaguedart"
			end
		end
	},
