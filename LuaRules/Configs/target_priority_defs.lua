...
--   Dirtbag is the highest among regular units at 18.67.
...
local unitIsHeavyHitter = {
	...
	[UnitDefNames["amphtanksubassault"].id] = true,
...
local unitIsCheap = {
	...
	[UnitDefNames["amphtankraid"].id] = true,
}
...
local unitIsHeavy = {
	...
	[UnitDefNames["stridersquire"].id] = true,
...
--	[WeaponDefNames["shipcarrier_armmship_rocket"].id] = 5,
	...
	[WeaponDefNames["amphtankarty_gauss"].id] = 5,
}
