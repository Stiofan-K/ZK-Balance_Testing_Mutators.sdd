return { amphtankcon = {
  ...
  weaponDefs             = {
    ...
    DEPTHCHARGE = {
      ...
      tracks                  = true,
      trajectoryHeight        = 1,
      turnRate                = 40000, -- have a look at this regarding raiders
      turret                  = true,
      weaponAcceleration      = 22,
      weaponTimer             = 0.5, -- Have a look at this too
      weaponType              = [[TorpedoLauncher]],
      weaponVelocity          = 400, -- and at this
    },
