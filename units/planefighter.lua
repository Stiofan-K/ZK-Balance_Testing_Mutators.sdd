return { planefighter = {
  ...
  footprintZ             = 2,
  frontToSpeed           = 0,
  health                 = 480, --I'd like swift to be more survivable to allow more room to play with them. This is just under the hp thresholds for swift missiles, and a little over chainsaw and harpy. Harpy can still kill 2 swift
  iconType               = [[fighter]],
