return { veharty = {
  ...
  customParams        = {
    ...
    outline_y = 80,
    outline_yoff = 12.5,
    manualfire_desc = [[Fire Special Weapon: Fire a Carpet Mine Burst.]]
  },
  ...
  weaponDefs          = {
    ...
    MINE_BURST = {
      ...
      myGravity               = 0.34,
      noSelfDamage            = true,
      range                   = 750, --Issue: Does not account for range gained by height in range circle, but allows fire
      reloadtime              = 33.6,
      soundHit                = [[weapon/cannon/badger_hit]],
      soundStart              = [[weapon/cannon/badger_fire]],
      soundHitVolume          = 8,
